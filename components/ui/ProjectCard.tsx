    ...
    >
      ...
      >
        <div className="relative h-full rounded-2xl overflow-hidden bg-[var(--surface)] border border-[var(--border)] transition-all duration-500 group-hover:border-[rgba(0,255,136,0.35)]">
          ...
          {/* Featured Badge */}
          {project.featured && (
            <div className="absolute top-4 left-4 z-30 px-2.5 py-1 rounded-md bg-[var(--accent-primary)] text-[var(--background)] text-xs font-semibold shadow-[0_4px_10px_rgba(0,255,136,0.2)] flex items-center gap-1.5">
